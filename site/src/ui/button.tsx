...
const buttonVariants = {
  variant: {
    primary:
      'border border-black bg-black text-cream hover:bg-cream hover:text-black',
    secondary: 'border border-black bg-cream text-black hover:bg-black hover:text-cream',
    ghost: 'border-none bg-transparent text-black hover:bg-gray-50 hover:text-gray-900',
    ...
    return (
      <button
        ...
        className={cn(
          ...
          'focus:outline-none focus-visible:outline-3 focus-visible:outline-offset-2',
          'touch-manipulation',
